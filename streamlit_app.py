...
st.set_page_config(page_title="NeuroCogni AI Disease Progression Analyzer", page_icon="🧠")
...
with st.form("patient_info"):
    ...
    with col1:
     ...
     # Add CSS to change input value and +/- button colors to black
        st.markdown("""
            <style>
                .st-ex-py-number-input .st-ex-py-input-container input,
                .st-ex-py-number-input .st-ex-py-button-container button {
                color: black; 
                }
            </style>
        """, unsafe_allow_html=True)
...
st.markdown(
    ...
    <style>
    .st-ci textarea { 
        background-color: #f0f0f0; /* Example background color: Light Gray */
        color: #333; /* Example text color: Dark Gray */
    }
    </style>
    """,
    unsafe_allow_html=True
